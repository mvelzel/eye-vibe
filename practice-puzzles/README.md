...
| [sdlwdr #3 — unresolved progression cipher](08-sdlwdr-03-unsolved-progression.md) | Unsolved; several finite families excluded | Remove possible IVs, use occupancy to test action counts, test `2n-1` as signed line steps as well as paired sheets, and require planted recovery of hidden geometry as well as the language key. |
