...
- complete side-band scope mapping;
- fresh-value allocator for the eight Type6 labels;
- historical asset delta that selects an unused role.

Require reproduction from raw assets and one held-out prediction.

Petri is now directly attributed as the Eye author, but the public data
...
chronologically plausible if the relevant text or developer access predates
