#!/usr/bin/env python3
"""Run the frozen 13-class asset-tape cut audit for Cipher #6."""
...
def main() -> None:
    ...
    print("prefix low/total fraction distinct max binary collation base cut")
    for result in results:
        ...
        print(
            ...
            f"{result.binary_direction:<3} {result.collation:<7} "
            f"{base:<4} {result.cut_direction}"
        )
